...
# ----------------SLURM Parameters----------------
#SBATCH -J EB20_pilon_TellSeq_reads_rnd2 #jobname
...
#cp /home/groups/earthbiogenome/results/20210407_EB20_ArrowPolished_purged_scaffolding/EB20_Arrow_purged_TellSeq_polished.fasta $SCRATCH
...
bwa index EB20_Arrow_purged_TellSeq_polished.fasta

# run bwa, use 20 threads for aligning and sorting and set memory for samtools at 3G per thread
bwa mem -t 12 EB20_Arrow_purged_TellSeq_polished.fasta \
 EB20_nobc_R1_T500.fastq.gz.corrected.fastq.err_barcode_removed.fastq.gz \
 EB20_nobc_R2_T500.fastq.gz.corrected.fastq.err_barcode_removed.fastq.gz | samtools sort -@12 -m 3G -o EB20_rnd1_TellSeq_sort.bam -

samtools index EB20_rnd1_TellSeq_sort.bam
...
java -Xmx250G -jar /home/apps/software/pilon/1.23-Java-1.8.0_152/pilon-1.23.jar --genome EB20_Arrow_purged_TellSeq_polished.fasta \
    --bam EB20_rnd1_TellSeq_sort.bam \
    --changes --diploid --threads 12 \
    --output EB20_Arrow_purged_TellSeq_polished_rnd2
    
cp EB20_rnd1_TellSeq_sort.* /home/groups/earthbiogenome/results/20210407_EB20_ArrowPolished_purged_scaffolding/
cp EB20_Arrow_purged_TellSeq_polished_rnd2.* /home/groups/earthbiogenome/results/20210407_EB20_ArrowPolished_purged_scaffolding/
