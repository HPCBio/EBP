...
# ----------------SLURM Parameters----------------
#SBATCH -J 20210524_EB20_FreeBayes_align_to_consensus #jobname
#SBATCH --mem=100g
#SBATCH -N 1 #nodes
...
#bwa index  EB20_Salsa_Sealer_scaffold.fa

#bwa mem -t 12 EB20_Salsa_Sealer_scaffold.fa EB20_nobc_R1_T500.fastq.gz.corrected.fastq.err_barcode_removed.fastq.gz EB20_nobc_R2_T500.fastq.gz.corrected.fastq.err_barcode_removed.fastq.gz >  EB20_purged_asm_vs_TellSeq.sam
#
# ----------------Load Modules--------------------
...
#samtools sort -o  EB20_purged_asm_vs_TellSeq_sorted.bam  EB20_purged_asm_vs_TellSeq.bam

#samtools index  EB20_purged_asm_vs_TellSeq_sorted.bam

samtools faidx  EB20_Salsa_Sealer_scaffold.fa
...
freebayes -f  EB20_Salsa_Sealer_scaffold.fa  EB20_purged_asm_vs_TellSeq_sorted.bam >  EB20_purged_asm_vs_TellSeq_sorted.vcf
...
bcftools --version
bcftools view -Ou -e'type="ref"'  EB20_purged_asm_vs_TellSeq_sorted.vcf | bcftools norm -Ob -f  EB20_Salsa_Sealer_scaffold.fa -o  EB20_purged_asm_vs_TellSeq_norm.bcf --threads 36

## Filter normalized bcf file and output as vcf

bcftools view -i 'QUAL>1 && (GT="AA" || GT="Aa")' -Oz --threads=36  EB20_purged_asm_vs_TellSeq_norm.bcf >  EB20_purged_asm_vs_TellSeq_filtered.vcf.gz
...
meryl count k=19 EB20_Salsa_Sealer_scaffold.fa  output  EB20_purged.meryl
...
merfin -vmer  -sequence  EB20_Salsa_Sealer_scaffold.fa -seqmers  EB20_purged.meryl -readmers EB20_nobc_all.meryl -peak ${peak} \
...
bcftools view -Oz  EB20_purged_asm_vs_TellSeq_filtered_sorted_out.dump.gz.polish.vcf >  EB20_purged_asm_vs_TellSeq_filtered_sorted_out.dump.gz.polish.vcf.gz #bgzip merfin output

bcftools index  EB20_purged_asm_vs_TellSeq_filtered_sorted_out.dump.gz.polish.vcf.gz

bcftools consensus  EB20_purged_asm_vs_TellSeq_filtered_sorted_out.dump.gz.polish.vcf.gz -f  EB20_Salsa_Sealer_scaffold.fa -H 1 >  EB20_purged_FreeBayes_merfin_polished.fasta 
...
bcftools consensus -Hla -f  EB20_Salsa_Sealer_scaffold.fa  EB20_purged_asm_vs_TellSeq_filtered_sorted.vcf.gz >  EB20_purged_FreeBayes_VGP_polished.fasta
